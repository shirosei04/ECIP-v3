<div class="modal fade" id="viewUserModal{{$user->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <form method="POST" id="editUserForm" action="">
                            ...
                            <div class="row smlFont">
                                <div class="col-md-4">
                                    ...
                                    <fieldset disabled>
                                        ...
                                        <input id="" type="text" class="form-control form-control-sm" value="{{$user->date_of_registration}}" disabled>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-4">
                                  ...
                                  <select class="form-select form-select-sm" aria-label="Default select example" name="role" disabled>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-check-input" type="radio" name="sex" id="inlineRadio" value="Male" {{ ($user->sex=="Male")? "checked" : "" }} disabled>
                                    <label class="form-check-label" for="inlineRadio" >Male</label>

                                    <input class="form-check-input" type="radio" name="sex" id="inlineRadio" value="Female" {{ ($user->sex=="Female")? "checked" : "" }} disabled>
                            ...
                            <div class="row smlFont">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="firstname" oninput="getValue()" name="first_name" aria-describedby="nameHelp" value="{{$user->first_name}}" disabled>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="mname" type="text" class="form-control form-control-sm" aria-describedby="mnameHelp" name="middle_name" value="{{$user->middle_name}}" disabled >
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="lastname" oninput="getValue()" name="last_name"  value="{{$user->last_name}}" disabled>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="lname" type="text" class="form-control form-control-sm" name="suffix" maxLength="10" aria-describedby="extensionHelp" value="{{$user->suffix}}" disabled>
                            ...
                            <div class="row mb-3 smlFont">
                                <div class="col-md-6">
                                    ...
                                    <input id="bdate" type="date" class="form-control form-control-sm" name="bdate" value="{{$user->birth_date}}" disabled>
                                    @if($errors->has('bdate'))
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="bplace" type="input" class="form-control form-control-sm" name="bplace" value="{{$user->birth_place}}" disabled>
                            ...
                            <div class="row mb-3 smlFont">
                                <div class="col-md-3">
                                    ...
                                    <input id="" type="string" class="form-control form-control-sm" name="region" value="{{$user->region}}" disabled>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input id="" type="string" class="form-control form-control-sm" name="province" value="{{$user->province}}" disabled>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input id="" type="string" class="form-control form-control-sm" name="city" value="{{$user->city}}" disabled>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input id="" type="string" class="form-control form-control-sm" name="barangay" value="{{$user->barangay}}"  disabled>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="building" type="text" class="form-control form-control-sm" name="street" value="{{$user->house_no}}" disabled>
                            ...
                            <div class="row smlFont">
                                <div class="col-md-3">
                                    ...
                                    <input id="ethnic" type="text" class="form-control form-control-sm" name="nationality" value="{{$user->nationality}}"  disabled>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="ethnic" type="text" class="form-control form-control-sm" name="religion"  value="{{$user->religion}}" disabled>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="ethnic" type="text" class="form-control form-control-sm" name="ethnicity" value="{{$user->ethnicity}}"  disabled>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="mtongue" type="text" class="form-control form-control-sm" name="mother_tongue" value="{{$user->mother_tongue}}" disabled >
                            ...
                            <div class="row smlFont">
                                <div class="col-md-3">
                                    ...
                                    <input id="tpno" type="text" class="form-control form-control-sm" name="tel_no" maxLength="10"  minLength="10" aria-describedby="telHelp" value="{{$user->tel_no}}" disabled  >
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="cpno" type="text" class="form-control form-control-sm" aria-describedby="cellHelp" maxLength="11"  minLength="11" name="cell_no" value="{{$user->cell_no}}"  disabled >
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="email" type="email" class="form-control form-control-sm" aria-describedby="emailHelp" name="email" value="{{$user->email}}"  disabled>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="" type="text" class="form-control form-control-sm" name="fb_acc" aria-describedby="fbHelp"  value="{{$user->fb_acc}}"  disabled>
                            ...
                            <div class="row smlFont">
                              <div class="col-md-4">
                                ...
                                <input type="number" class="form-control form-control-sm" value="{{$user->student->lrn}}" name="lrn" disabled>
                              </div>
  
                              <div class="col-md-4">
                                <label for="" class="col-12 col-form-label text-start fw-bold">{{ __('Grade Level') }}</label>
                                <input type="number" class="form-control form-control-sm" value="{{$user->student->grade_lvl}}" name="lrn" disabled>
                              </div>
                              <div class="col-md-4">
                                  <label for="" class="form-check-label fw-bold">Do you have an available guardian for remote learning?</label>
                                  <div class="row"> 
                                      <div class="col-md-6">
                                          <input class="form-check-input" type="radio" name="hgfrl" id="inlineRadio4" value="1" {{ ($user->student->hgfrl=="1")? "checked" : "" }} disabled>
                                          <label class="form-check-label" for="inlineRadio4">Yes</label>
                                      </div>
                                  </div>
                                  <div class="row smlFont"> 
                                      <div class="col-md-6">
                                          <input class="form-check-input" type="radio" name="hgfrl" id="inlineRadio4" value="0" {{ ($user->student->hgfrl=="0")? "checked" : "" }} disabled>
                         ...
                         <div class="row smlFont">
                              <div class="col-md-4">
                                  ...
                                  <input type="text" class="form-control form-control-sm" value="{{$user->student->past_school}}" name="past_school" disabled>
                              </div>

                              <div class="col-md-4">
                                  <label class="form-label fw-bold">Past School Address</label>
                                  <input type="text" class="form-control form-control-sm" value="{{$user->student->past_school_address}}" name="past_school_add" disabled>
                              ...
                              <div class="col-md-4">
                                  ...
                                  <input type="text" class="form-control form-control-sm" value="{{$user->student->past_school_id}}" name="past_school_id" disabled>
                              </div>
                          </div>
                          <hr>
                          ...
                          <div class="row smlFont">
                              <div class="col-md-4">
                                      ...
                                      <div class="row"> 
                                          <div class="col-md-3">
                                              ...
                                              <label class="form-check-label" for="inlineRadio7">Yes</label disabled>
                                          </div>
                                      </div>
                                      <div class="row"> 
                                          <div class="col-md-3">
                                              ...
                                              <label class="form-check-label" for="inlineRadio7">No</label disabled>
                                          </div>
                                          <label for=""></label>
                                          <input id="" type="text" class="form-control mt-1 mb-3 comorbidity" name="illnesses" value="{{$user->student->illnesses}}" placeholder="If yes, please specify" disabled>
                                      </div>
                              </div>
                              ...
                              <div class="col-md-4">
                                  ...
                                  <div class="row">
                                      <div class="">
                                          <input class="form-check-input" type="radio" name="vaccine_status" id="inlineRadio6" value="Unvaccinated" {{ ($user->student->vaccine_status=="Unvaccinated")? "checked" : "" }} disabled>
                                          <label class="form-check-label" for="inlineRadio6">Unvaccinated</label>
                                      </div>
                                  </div>
                                  <div class="row ">
                                      <div class="">
                                          <input class="form-check-input" type="radio" name="vaccine_status" id="inlineRadio6" value="Partial" {{ ($user->student->vaccine_status=="Partial")? "checked" : "" }} disabled>
                                          <label class="form-check-label" for="inlineRadio6">Partial</label>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="">
                                          <input class="form-check-input" type="radio" name="vaccine_status" id="inlineRadio6" value="Full" {{ ($user->student->vaccine_status=="Full")? "checked" : "" }} disabled>
                                          <label class="form-check-label" for="inlineRadio6">Full</label>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="">
                                          <input class="form-check-input" type="radio" name="vaccine_status" id="inlineRadio6" value="Boosted" {{ ($user->student->vaccine_status=="Boosted")? "checked" : "" }} disabled>
                              ...
                              <div class="col-md-4">
                                  ...
                                  <div class="row">
                                      <div class="col-md-12">
                                          <input class="form-check-input" type="radio" name="mogts" id="inlineRadio3" value="Walking" {{ ($user->student->mogts=="Walking")? "checked" : "" }} disabled>
                                          <label class="form-check-label" for="inlineRadio3">Walking</label>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-md-12">
                                          <input class="form-check-input" type="radio" name="mogts" id="inlineRadio3" value="Personal Vehicle" {{ ($user->student->mogts=="Personal Vehicle")? "checked" : "" }} disabled>
                                          <label class="form-check-label" for="inlineRadio3">Personal Vehicle</label>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-md-12">
                                          <input class="form-check-input" type="radio" name="mogts" id="inlineRadio3" value="Public Utility Vehicle (PUV)" {{ ($user->student->mogts=="Public Utility Vehicle (PUV)")? "checked" : "" }} disabled>
                          ...
                          <div class="row smlFont">
                             <div class="col-md-6">
                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          <input class="form-check-input" type="radio" name="is_4ps_member" id="inlineRadio1" value="1" {{ ($user->student->is_4ps_member=="1")? "checked" : "" }} disabled>  
                                          <label class="form-check-label" for="inlineRadio1">Yes</label>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-md-6">
                                          <input class="form-check-input" type="radio" name="is_4ps_member" id="inlineRadio1" value="0" {{ ($user->student->is_4ps_member=="0")? "checked" : "" }} disabled>
                             ...
                             <div class="col-md-6">
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <input class="form-check-input" type="radio" name="is_madrasah_enrolled" id="inlineRadio2" value="1" {{ ($user->student->is_madrasah_enrolled=="1")? "checked" : "" }} disabled>
                                      <label class="form-check-label" for="inlineRadio2">Yes</label>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-md-6">
                                      <input class="form-check-input" type="radio" name="is_madrasah_enrolled" id="inlineRadio2" value="0" {{ ($user->student->is_madrasah_enrolled=="0")? "checked" : "" }} disabled>
                          ...
                          @foreach($user->parents as $parent)
                           ...
                           $c++;
                           ?>
                            <h6 class="text-white"  style="background-color: #4168dc; text-align: center">{{$parent->relationship}}</h6>
                          <div id="parentDiv">
                              <div>
                                  <div class="row">
                                      ...
                                      <div class="col-md-3">
                                          ...
                                          <input id="" type="text" class="form-control form-control-sm" name="inputs[{{$c}}][first_name]" value="{{$parent->first_name}}" disabled>
                                      </div>
          
                                      <div class="col-md-2">
                                          <label for="" class="col-12 col-form-label text-start">{{ __('Middle Name') }}</label>
                                          <input id="" type="text" class="form-control form-control-sm" name="inputs[{{$c}}][middle_name]" value="{{$parent->middle_name}}"  disabled>
                                      </div>
          
                                      <div class="col-md-3">
                                          <label for="" class="col-12 col-form-label text-start">{{ __('Last Name') }}</label>
                                          <input id="" type="text" class="form-control form-control-sm" name="inputs[{{$c}}][last_name]" value="{{$parent->last_name}}" disabled >
                                      ...
                                      <div class="col-md-1">
                                          ...
                                          <input id="" type="text" class="form-control form-control-sm" name="inputs[{{$c}}][suffix]" value="{{$parent->suffix}}" disabled >
                                      </div>

                                      <div class="col-md-3">
                                          <label for="" class="col-12 col-form-label text-start">{{ __('Relationship') }}</label>
                                          <input id="" type="text" class="form-control form-control-sm" name="inputs[{{$c}}][occupation]" value="{{$parent->relationship}}" disabled>
                                      </div>
                                  </div>
                                  ...
                                  <div class="row">
                                      <div class="col-md-3">
                                          ...
                                          <input id="" type="text" class="form-control form-control-sm" name="inputs[{{$c}}][occupation]" value="{{$parent->occupation}}" disabled>
                                      </div>
          
                                      <div class="col-md-3">
                                          <label for="" class="col-12 col-form-label text-start">{{ __('Contact Number') }}</label>
                                          <input id="" type="number" class="form-control form-control-sm" name="inputs[{{$c}}][contact_no]" value="{{$parent->contact_no}}" disabled>
                                      </div>
          
                                      <div class="col-md-3">
                                          <label for="" class="col-12 col-form-label text-start">{{ __('Email Address') }}</label>
                                          <input id="memail" type="email" class="form-control form-control-sm" name="inputs[{{$c}}][email]" value="{{$parent->email}}" disabled>
                                      </div>
          
                                      <div class="col-md-3">
                                          <label for="" class="col-12 col-form-label text-start">{{ __('Facebook Account') }}</label>
                                          <input id="" type="text" class="form-control form-control-sm" name="inputs[{{$c}}][fb_account]" value="{{$parent->fb_account}}"  disabled>
                                      </div>
                                  </div>
