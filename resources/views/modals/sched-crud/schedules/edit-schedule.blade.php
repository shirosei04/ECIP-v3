<div class="modal fade" id="editSchedModal{{$sched->sched_id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="container">
                <div class="card mt-4">
                    <div class="card-header">
                        <h5>Edit Schedule Details</h5>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{url('edit-sched/'.$sched->sched_id)}}">
                            @csrf
                            @method('PUT')
                            <div class="row ">
                                <div class="mb-3 ">
