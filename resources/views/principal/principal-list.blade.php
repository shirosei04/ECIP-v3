        ...
        <div class="card-header tableCardHeader">
            <form action="{{ url('searchprincipal') }}" type="get">
                <div class="col-md-3 float-end">
                    <input type="search" class="form-control" placeholder="Search Principal" name="query">
                </div> 
                <div class="float-end">
                    <a type="button" href="{{url('/principal-list')}}"  class="btn btn-primary"><i class="fas fa-sync-alt"></i></a>
                </div>
            </form>
            <h3><i class="fas fa-user-cog"></i> Principals</h3>
        </div>
        <div class="p-2" >
